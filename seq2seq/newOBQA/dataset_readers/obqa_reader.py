...
@DatasetReader.register("obqa_copynet_seq2seq")
class ObqaCopyNetDatasetReader(DatasetReader):
    """
    ...
    *including* the ``START_SYMBOL`` and ``END_SYMBOL``.
    ...
    def __init__(self,
        ...
        if "tokens" not in self._source_token_indexers or \
            ...
            raise ConfigurationError("ObqaCopyNetDatasetReader expects 'source_token_indexers' to contain "
    ...
    def _read(self, file_path):
        with open(cached_path(file_path), "r") as data_file:
            ...
            for line_num, line in enumerate(data_file):
                ...
                source_sequence, target_sequence, src_id = line_parts
                if not source_sequence:
                    continue
                yield self.text_to_instance(src_id, source_sequence, target_sequence)
    ...
    @overrides
    def text_to_instance(self, src_id: str, source_string: str, target_string: str = None) -> Instance:  # type: ignore
        """
